...
ZO_CreateStringId("SK_SCAN_FREQ_NAME", "スキャン間隔")
ZO_CreateStringId("SK_SCAN_FREQ_TIP", "ギルドストアセールスのチェックをどのくらいの間隔（秒単位）で行うかを設定します。")
...
ZO_CreateStringId("SK_ACCOUNT_WIDE_NAME", "アカウントワイド設定")
ZO_CreateStringId("SK_ACCOUNT_WIDE_TIP", "全ての設定をアカウントの全てのキャラクターに適用します。")
...
ZO_CreateStringId("SK_DELAY_INIT_NAME", "初期化ディレイ")
ZO_CreateStringId("SK_DELAY_INIT_TIP", "ログインに問題がある場合、キャラクターがロードされた後初期化にディレイを設けます。")
...
ZO_CreateStringId("SK_TIME_SECONDS", "<<1[今/%d秒前]>>")
ZO_CreateStringId("SK_TIME_MINUTES", "<<1[%d分前]>>")
ZO_CreateStringId("SK_TIME_HOURS", "<<1[%d時間前]>>")
ZO_CreateStringId("SK_TIME_DAYS", "<<1[昨日/%d日前]>>")
ZO_CreateStringId("SK_TIME_SECONDS_LC", "<<1[今/%d秒前]>>")
ZO_CreateStringId("SK_TIME_MINUTES_LC", "<<1[%d分前]>>")
ZO_CreateStringId("SK_TIME_HOURS_LC", "<<1[%d時間前]>>")
ZO_CreateStringId("SK_TIME_DAYS_LC", "<<1[昨日/%d日前]>>")
...
ZO_CreateStringId("MM_POSTED_FOR", "ポストされて")
...
ZO_CreateStringId("MM_INDEX_3DAY", "昨日")
...
ZO_CreateStringId("MM_AUTO_ADVANCE_NAME", "自動で次のページに進む")
ZO_CreateStringId("MM_AUTO_ADVANCE_TIP", "ギルドストアページの全てのアイテムがフィルタされている場合、自動的に次のページに進みます。")
