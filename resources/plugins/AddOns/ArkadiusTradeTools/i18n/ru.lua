local localization =
{
    ...
    ATT_STR_GENERAL                                 = "Основные",
    ATT_STR_SHOW_WINDOW_ON_MAIL                     = "Показывать окно вместе с Почтой",
    ATT_STR_SHOW_WINDOW_ON_GUILDSTORE               = "Показывать окно вместе с Магазином",
    ATT_STR_SHOW_WINDOW_ON_CRAFTINGSTATION          = "Показывать окно вместе с Ремесленными станциями",
    ATT_STR_SHOW_NOTIFICATIONS                      = "Показывать уведомления",
    ...
    ATT_STR_SCAN_LONG_INTERVAL                      = "Интервал 1 (секунды)",
    ATT_STR_SCAN_SHORT_INTERVAL                     = "Интервал 2 (миллисекунды)",
    ATT_STR_DONATE                                  = "Подарить",
    ATT_STR_DONATE_TOOLTIP                          = "Вам нравится этот аддон? Тогда сделайте подарок его разработчику – @Aldanga :-)",
    ATT_STR_GUILDSTATUS_TEXT                        = "Обновление данных",
